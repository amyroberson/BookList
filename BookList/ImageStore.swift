...
extension FileManager {
    var documentsDirectory: URL {
        ...
        //throw if there isn't a directory
...
internal class ImageStore<Key : ImageKeyExtractable> {
    ...
    fileprivate func imageURLForKey(_ key: Key) -> URL { //why doesn't this return an optional
    ...
    internal func imageForKey(_ key: Key) -> UIImage? {
        if let exisitingImage = cache.object(forKey: key.imageKey as NSString) {
